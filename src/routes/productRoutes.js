...
router.post("",authorize("ADMIN"),uploadFiler.single("image"), controller.createProduct);
router.get("/:id", controller.getProductId);
router.put("/:id",authorize("ADMIN"),uploadFiler.single("image"), controller.updateProduct);
